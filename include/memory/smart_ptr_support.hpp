...
namespace std {
    ...
    requires is_default_constructible_v<hash<typename unique_ptr<T, D>::pointer>>
    ...
    template<class T>
    struct hash<shared_ptr<T>> : hash<__internal::__enabled_hash_t> {
