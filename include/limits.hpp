...
namespace std {
    ...
    namespace __internal {
        ...
        struct __specialized_integral_numeric_limits {
            ...
            static constexpr T min() noexcept {
                return is_signed_v<T> ? -max() - 1 : T(0);
            }
    ...
    template<>
    class numeric_limits<char> : public __internal::__specialized_integral_numeric_limits<char> {};

    template<>
    class numeric_limits<signed char> : public __internal::__specialized_integral_numeric_limits<signed char> {};

    template<>
    class numeric_limits<unsigned char> : public __internal::__specialized_integral_numeric_limits<unsigned char> {};

    template<>
    class numeric_limits<wchar_t> : public __internal::__specialized_integral_numeric_limits<wchar_t> {};

    template<>
    class numeric_limits<char8_t> : public __internal::__specialized_integral_numeric_limits<char8_t> {};

    template<>
    class numeric_limits<char16_t> : public __internal::__specialized_integral_numeric_limits<char16_t> {};

    template<>
    class numeric_limits<char32_t> : public __internal::__specialized_integral_numeric_limits<char32_t> {};

    template<>
    class numeric_limits<short> : public __internal::__specialized_integral_numeric_limits<short> {};

    template<>
    class numeric_limits<unsigned short> : public __internal::__specialized_integral_numeric_limits<unsigned short> {};

    template<>
    class numeric_limits<int> : public __internal::__specialized_integral_numeric_limits<int> {};

    template<>
    class numeric_limits<unsigned int> : public __internal::__specialized_integral_numeric_limits<unsigned int> {};

    template<>
    class numeric_limits<long> : public __internal::__specialized_integral_numeric_limits<long> {};

    template<>
    class numeric_limits<unsigned long> : public __internal::__specialized_integral_numeric_limits<unsigned long> {};

    template<>
    class numeric_limits<long long> : public __internal::__specialized_integral_numeric_limits<long long> {};

    template<>
    class numeric_limits<unsigned long long> : public __internal::__specialized_integral_numeric_limits<unsigned long long> {};
