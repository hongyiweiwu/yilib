...
namespace std::numbers {
    template<class T>
    inline constexpr T e_v = __internal::always_illformed<T>{};
    template<class T>
    inline constexpr T log2e_v = __internal::always_illformed<T>{};
    template<class T>
    inline constexpr T log10e_v = __internal::always_illformed<T>{};
    template<class T>
    inline constexpr T pi_v = __internal::always_illformed<T>{};
    template<class T>
    inline constexpr T inv_pi_v = __internal::always_illformed<T>{};
    template<class T>
    inline constexpr T inv_sqrtpi_v = __internal::always_illformed<T>{};
    template<class T>
    inline constexpr T ln2_v = __internal::always_illformed<T>{};
    template<class T>
    inline constexpr T ln10_v = __internal::always_illformed<T>{};
    template<class T>
    inline constexpr T sqrt2_v = __internal::always_illformed<T>{};
    template<class T>
    inline constexpr T sqrt3_v = __internal::always_illformed<T>{};
    template<class T>
    inline constexpr T inv_sqrt3_v = __internal::always_illformed<T>{};
    template<class T>
    inline constexpr T egamma_v = __internal::always_illformed<T>{};
    template<class T>
    inline constexpr T phi_v = __internal::always_illformed<T>{};
